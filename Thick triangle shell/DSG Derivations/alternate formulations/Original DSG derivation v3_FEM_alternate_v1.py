...
# !!!!!!!! calculate shear volume then determine average shear gap !!!!!!!!!!!
# Shear volumes and average shear gaps
sg_gamma_xi_vol1 = sp.integrate(sg_xi_sf,(eta,0.0,1.0-xi))
sg_gamma_xi_vol = sp.integrate(sg_gamma_xi_vol1,(xi,0.0,1.0))
sg_gamma_xi_av = sg_gamma_xi_vol/0.5 #average shear gap across whole element

sg_gamma_eta_vol1 = sp.integrate(sg_eta_sf,(eta,0.0,1.0-xi))
sg_gamma_eta_vol = sp.integrate(sg_gamma_eta_vol1,(xi,0.0,1.0))
sg_gamma_eta_av = sg_gamma_eta_vol/0.5 #average shear gap across whole element

print("sg_gamma_xi_vol\n",sg_gamma_xi_vol)
print("sg_gamma_xi_av\n",sg_gamma_xi_av)
print("sg_gamma_eta_av\n",sg_gamma_eta_av)

# assign average shear gaps to those with previous zero value
sg_xi_n1 = sg_xi_n1 - sg_gamma_xi_av
sg_xi_n2 = sg_xi_n2 - sg_gamma_xi_av
sg_xi_n3 = sg_xi_n3 - sg_gamma_xi_av

sg_eta_n1 = sg_eta_n1 - sg_gamma_eta_av
sg_eta_n2 = sg_eta_n2 - sg_gamma_eta_av
sg_eta_n3 = sg_eta_n3 - sg_gamma_eta_av

# re-define shear gap field
sg_xi_sf = N1*sg_xi_n1 + N2*sg_xi_n2 + N3*sg_xi_n3
sg_eta_sf = N1*sg_eta_n1 + N2*sg_eta_n2 + N3*sg_eta_n3
