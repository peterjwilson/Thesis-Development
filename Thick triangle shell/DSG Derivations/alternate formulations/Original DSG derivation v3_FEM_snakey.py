...
W_ref = W1/3.0 + W2/3.0 + W3/3.0
#W_ref = W_test.subs([(xi,0)])
sg_xi_n1 = W_test.subs([(xi,0)])- W_ref + sp.integrate(phi_xi*a + phi_eta*b,(xi,0,0)).subs([(xi,0),(eta,0)])

sg_xi_n2 = W_test.subs([(xi,1)])- W_ref + sp.integrate(phi_xi*a + phi_eta*b,(xi,0,1)).subs([(xi,1),(eta,0)])

sg_xi_n3 = W_test.subs([(xi,0)])- W_ref + sp.integrate(phi_xi*a + phi_eta*b,(xi,0,0)).subs([(xi,0),(eta,1)])

#W_ref = W_test.subs([(xi,0),(eta,0)])
sg_eta_n1 = W_test.subs([(xi,0),(eta,0)]) - W_ref + sp.integrate(phi_xi*d + phi_eta*c,(eta,0,0)).subs([(xi,0),(eta,0)])

sg_eta_n2 = W_test.subs([(xi,1),(eta,0)])- W_ref + sp.integrate(phi_xi*d + phi_eta*c,(eta,0,0)).subs([(xi,1),(eta,0)])

sg_eta_n3 = W_test.subs([(xi,0),(eta,1)])- W_ref + sp.integrate(phi_xi*d + phi_eta*c,(eta,0,1)).subs([(xi,0),(eta,1)])
