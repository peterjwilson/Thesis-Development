...
Wref = W_test.subs([(xi,1.0/3.0)])
sg_xi_n1 = W_test.subs([(xi,0),(eta,0)])- Wref.subs(eta,0) + sp.integrate(phi_xi*a + phi_eta*b,(xi,1.0/3.0,0)).subs([(xi,0),(eta,0)])

sg_xi_n2 = W_test.subs([(xi,1),(eta,0)])- Wref.subs(eta,0) + sp.integrate(phi_xi*a + phi_eta*b,(xi,1.0/3.0,1)).subs([(xi,1),(eta,0)])

sg_xi_n3 = W_test.subs([(xi,0),(eta,1)])- Wref.subs(eta,1) + sp.integrate(phi_xi*a + phi_eta*b,(xi,1.0/3.0,0)).subs([(xi,0),(eta,1)])

sg_xi_n4 = W_test.subs([(xi,1.0/3.0),(eta,1.0/3.0)])- Wref.subs(eta,1.0/3.0) + sp.integrate(phi_xi*a + phi_eta*b,(xi,1.0/3.0,1.0/3.0)).subs([(xi,1.0/3.0),(eta,1.0/3.0)])
...
Wref = W_test.subs([(eta,1.0/3.0)])
sg_eta_n1 = W_test.subs([(xi,0),(eta,0)]) - Wref.subs(xi,0)+ sp.integrate(phi_xi*d + phi_eta*c,(eta,1.0/3.0,0)).subs([(xi,0),(eta,0)])

sg_eta_n2 = W_test.subs([(xi,1),(eta,0)])- Wref.subs(xi,1) + sp.integrate(phi_xi*d + phi_eta*c,(eta,1.0/3.0,0)).subs([(xi,1),(eta,0)])

sg_eta_n3 = W_test.subs([(xi,0),(eta,1)])- Wref.subs(xi,0) + sp.integrate(phi_xi*d + phi_eta*c,(eta,1.0/3.0,1)).subs([(xi,0),(eta,1)])

sg_eta_n4 = W_test.subs([(xi,1.0/3.0),(eta,1.0/3.0)])- Wref.subs(xi,1.0/3.0) + sp.integrate(phi_xi*d + phi_eta*c,(eta,1.0/3.0,1.0/3.0)).subs([(xi,1.0/3.0),(eta,1.0/3.0)])
