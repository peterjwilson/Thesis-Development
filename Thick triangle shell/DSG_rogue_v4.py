...
N2 = 1.0/detJ*((x3*y1 - x3*y2)+x*(y3-y1)+y*(x1-x3))
...
sg_x_n1 = W_test.subs([(x,x1),(y,y1)]) - W_test.subs([(x,x1),(y,y1)]) + (sp.integrate(gamma_x*a + gamma_y*b,(x,x1,x1))).subs([(x,x1),(y,y1)])
print("\n\n sg_x_n1 =:",sg_x_n1.subs([(x1,0),(y1,0),(x2,1),(y2,0),(x3,0),(y3,1)]))

sg_x_n2 = W_test.subs([(x,x2),(y,y2)])- W_test.subs([(x,x1),(y,y2)]) + sp.integrate(gamma_x*a + gamma_y*b,(x,x1,x2)).subs([(x,x2),(y,y2)])
print("\n\n sg_x_n2 =:",sg_x_n2.subs([(x1,0),(y1,0),(x2,1),(y2,0),(x3,0),(y3,1)]))

sg_x_n3 = W_test.subs([(x,x3),(y,y3)])- W_test.subs([(x,x1),(y,y3)]) + sp.integrate(gamma_x*a + gamma_y*b,(x,x1,x3)).subs([(x,x3),(y,y3)])
print("\n\n sg_x_n3 =:",sg_x_n3.subs([(x1,0),(y1,0),(x2,1),(y2,0),(x3,0),(y3,1)]))


sg_x_sf = N1*sg_x_n1 + N2*sg_x_n2 + N3*sg_x_n3
print("\n\n sg_x_sf=",sg_x_sf.subs([(x1,0),(y1,0),(x2,1),(y2,0),(x3,0),(y3,1)]))



sg_y_n1 = W_test.subs([(x,x1),(y,y1)]) - W_test.subs([(x,x1),(y,y1)]) + (sp.integrate(gamma_x*d + gamma_y*c,(y,y1,y1))).subs([(x,x1),(y,y1)])
print("\n\n sg_y_n1 =:",sg_y_n1.subs([(x1,0),(y1,0),(x2,1),(y2,0),(x3,0),(y3,1)]))

sg_y_n2 = W_test.subs([(x,x2),(y,y2)])- W_test.subs([(x,x2),(y,y1)]) + sp.integrate(gamma_x*d + gamma_y*c,(y,y1,y2)).subs([(x,x2),(y,y2)])
print("\n\n sg_y_n2 =:",sg_y_n2.subs([(x1,0),(y1,0),(x2,1),(y2,0),(x3,0),(y3,1)]))

sg_y_n3 = W_test.subs([(x,x3),(y,y3)])- W_test.subs([(x,x3),(y,y1)]) + sp.integrate(gamma_x*d + gamma_y*c,(y,y1,y3)).subs([(x,x3),(y,y3)])
print("\n\n sg_y_n3 =:",sg_y_n3.subs([(x1,0),(y1,0),(x2,1),(y2,0),(x3,0),(y3,1)]))
...
print("\n\n\nSymbolic B Matrix ( cartesian space) = ")
...
#B = B.subs([(x2-x1,a),(y2-y1,b),(y3-y1,c),(x3-x1,d)])
...
#Bsimp = Bsimp.subs(detJ,a*c-b*d)
#Bsimp = Bsimp.subs([(x2-x1,a),(y2-y1,b),(y3-y1,c),(x3-x1,d)])
#Bsimp = sp.simplify(Bsimp)
#Bsimp = sp.cancel(Bsimp)
for col in range(9):
