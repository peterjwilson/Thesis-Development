...
print("\n\n sg_xi_sf evaluated on unit triangle=",sg_xi_sf.subs([(xi1,0),(xi2,1.0),(xi3,0),(eta1,0),(eta2,0),(eta3,1.0)]))

sg_eta_sf = N1*sg_eta_n1 + N2*sg_eta_n2 + N3*sg_eta_n3
print("\n\n sg_y_sf evaluated on unit triangle=",sg_eta_sf.subs([(xi1,0),(xi2,1.0),(xi3,0),(eta1,0),(eta2,0),(eta3,1.0)]))
...
print("\n\nshear strain field x without subs = \n",gx_u)
print("\n\nshear strain field x with subs = \n",gx_u.subs([(xi1,0.0),(xi2,1.0),(xi3,0.0),(eta1,0.0),(eta2,0.0),(eta3,1.0)]))
...
# Assemble B Matrix ------------------------------------------
print("\n\n\nSymbolic B Matrix ( parametric space, unit triangle) = ")
B = sp.zeros(2,9)
for col in range(9):
...
#B = B.subs([(xi1,0.0),(xi2,1.0),(xi3,0),(eta1,0),(eta2,0),(eta3,1.0)])
B = B.subs([(xi1,x1),(xi2,x2),(xi3,x3),(eta1,y1),(eta2,y2),(eta3,y3)])
